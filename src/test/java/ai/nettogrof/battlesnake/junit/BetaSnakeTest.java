...
public class BetaSnakeTest {
	 ...
	 */
	@Test
	void startBeta() throws JsonMappingException, JsonProcessingException, InterruptedException {
		...
		t.setCpuLimit(4);
		assertTrue(t.start(parsedRequest).toString().contains("apiversion=1"));
