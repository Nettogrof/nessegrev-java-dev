...
import ai.nettogrof.battlesnake.snakes.LeftSnake;
...
public class LeftSnakeTest {
	 ...
	 */
	@Test
	public void startLeft() throws JsonMappingException, JsonProcessingException, InterruptedException {

		final JsonNode parsedRequest = json.readTree(PRETEST);

		final LeftSnake snakeAi = new LeftSnake("test");
