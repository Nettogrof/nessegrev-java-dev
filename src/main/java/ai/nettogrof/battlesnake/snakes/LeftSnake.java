 ...
 * @version Summer 2021
 */
public class LeftSnake extends ExpertSnake {
	...
	protected Constructor<? extends AbstractSearch> genSearchType() throws ReflectiveOperationException {
		...
		return LeftRoyaleSearch.class.getConstructor(AbstractNode.class, int.class, int.class, long.class, int.class, GameRuleset.class);
