...
/**
 * This abstract standard node class is the based of all node class, provide basic method use in any node for standard rules.
 * 
...
public abstract class AbstractStandardNode extends AbstractNode {
	...
	/**
	 * Adjust the score based on number of square controls by snakes
	 * The board array contain the snake number from 1 to X snakes
