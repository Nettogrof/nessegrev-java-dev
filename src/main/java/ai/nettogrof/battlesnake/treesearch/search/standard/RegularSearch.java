...
/**
 *  This regular search was used during the Winter classic 2020 by my Beta and Gamma snake
 *  It start by search the smallest branch and expand it (100 times) then :
 *  1. find the best branch from the root
 *  2. expand the best leaf node
 *  3. expand 6 time the smallest branch from the best node (found in step 1).
 *  
...
public class RegularSearch extends AbstractStandardSearch  {
	 ...
	 */
	public RegularSearch(final AbstractNode root, final int width, final int height, final long starttime, final int timeout) {
		super(root,width,height);
